        ...
        <>
            <p.PlanSection>
                <p.Container ref={planRef} >
                    <p.Text color='#222' margin='3rem 0' fontweight='700' fontsize='4.5rem'>Tour Plan </p.Text>
                        ...
                        data.map((data, i) => {
                            return (
                                <p.PlanWrapper key={i}   >
                                    ...
                                    <p.PlanRow onClick={()=>{setOpen(i)}}   >
                                        <p.DayLabel >
                                            <p.Text color='#fff' fontweight='500' fontsize='1.5rem'>Day {data.day}  </p.Text>
                                        </p.DayLabel>
                                        <p.Text color='#333' margin='0 0 0 1rem' fontweight='600' fontsize='1.7rem'>{ data.title}</p.Text>
                                                ...
                                                return (
                                                    <p.PlanBodyRow >
                                                        <p.IconContainer >
                                                            ...
                                                            <p.Text color='#333' margin='0 0 0 1rem' fontweight='500' fontsize='1.5rem'>
                                                                {desc}
                                                            </p.Text>
                                                        </p.IconContainer>
                                                    </p.PlanBodyRow>
