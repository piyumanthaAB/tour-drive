...
export default function LoginForm() {
  ...
  const { login, continueWithGoogle, user, isAuthenticated, loading } = useAuth();
    ...
    <l.MainContainer>
      <l.LoginContainer onSubmit={onSubmit}>
        ...
        Hey, Enter your details to get sign in 
         ...
         <l.LabelText>
          <l.LabelTextEmail value={email} onChange={e=>setEmail(e.target.value)} placeholder='  Enter Email'></l.LabelTextEmail>
         </l.LabelText>
         <l.LabelTextTwo>
         ...
         <l.GoogleLoginButton onClick={()=>googleLogin()} >Continue with Google</l.GoogleLoginButton>
